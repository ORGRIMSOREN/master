...
public class ItemEditor : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        LoadDataBase();
        GenerateListView(GetItemListView());
    }
    #region 
    ...
    private void GenerateListView(ListView itemListView)
    {
    ...
    private void OnListSelectionChange(IEnumerable<object>seletedItem)
    {
        activeItem=(ItemDetails)seletedItem.First();
        GetItemDetails();
    ...
    private void GetItemDetails()
    {
        ...
        //其他所有变量的绑定
        itemDetailsSection.Q<ObjectField>("ItemSprite").value = activeItem.itemonWorld;
